...
public class BedShader : MonoBehaviour 
{

    // Use this for initialization
    void Start ()
	{
		Texture2D tex1 	= (Texture2D)Resources.Load("bed_COLOR", typeof(Texture2D));
		Texture2D tex2  = (Texture2D)Resources.Load("bed_NRM", typeof(Texture2D));
