 ...
 * Version: 2.0
 * Script that applies color and normal map textures to Ethan ThirdPlayerController with Trilinear and Anisotropic filters
 */
...
public class EthanShader : MonoBehaviour 
{
    ...
    void Start ()
	{
		Texture2D tex1 	= (Texture2D)Resources.Load("ethan_COLOR", typeof(Texture2D)); // COLOR TEXTURE
        Texture2D tex2  = (Texture2D)Resources.Load("ethan_NRM", typeof(Texture2D)); // NORMAL MAP
