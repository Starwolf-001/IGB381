/*
* Name: BearShader.shader
* Date: 08/09/2017
* Author: Michael Cartwright
* Version: 3.0
* Shader for Bear Statue
...
{
	/*
	* Properties for user to change for Bear Statue
	...
	*/
	...
	/*
	* Subshader used for Bear Statue in Assignment_1
	...
	*/
	Subshader
	{
		...
		* Post: Produces lighting effects for Bear Statue from Sun directional light source using FirstPass.cginc custom shader
		*/
		Pass
		{
