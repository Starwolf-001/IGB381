...
public class RadarShader : MonoBehaviour 
{

    // Use this for initialization
    void Start ()
	{
		Texture2D tex1 	= (Texture2D)Resources.Load("radardish_COLOR", typeof(Texture2D));
		Texture2D tex2  = (Texture2D)Resources.Load("radardish_NRM", typeof(Texture2D));
