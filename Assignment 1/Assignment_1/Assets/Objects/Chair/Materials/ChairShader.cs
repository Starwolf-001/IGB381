...
public class ChairShader : MonoBehaviour 
{
    ...
    void Start ()
	{
		Texture2D tex1 	= (Texture2D)Resources.Load("chair_COLOR", typeof(Texture2D)); // COLOR TEXTURE
		Texture2D tex2  = (Texture2D)Resources.Load("chair_NRM", typeof(Texture2D)); // NORMAL MAP
