 ...
 * Version: 2.0
 * Script that applies color and normal map textures to Lion Statue with Trilinear and Anisotropic filters
 */

using UnityEngine;
using System.Collections;

public class LionShader : MonoBehaviour 
{
    ...
    void Start ()
	{
		Texture2D tex1 	= (Texture2D)Resources.Load("Lion_Statue_COLOR", typeof(Texture2D)); // COLOR TEXTURE
        Texture2D tex2  = (Texture2D)Resources.Load("Lion_Statue_NRM", typeof(Texture2D)); // NORMAL MAP
