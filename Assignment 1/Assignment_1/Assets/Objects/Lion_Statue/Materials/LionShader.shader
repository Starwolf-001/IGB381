/*
* Name: LionShader.shader
* Date: 08/09/2017
* Author: Michael Cartwright
* Version: 3.0
* Shader for Object Lion Statue
...
{	
	/*
	* Properties for user to change for Lion Statue
	...
	*/
	...
	/*
	* Subshader used for Lion Statue in Assignment_1
	...
	*/
	Subshader
	{
		...
		* Post: Produces lighting effects for Lion Statue from Sun directional light source using FirstPass.cginc custom shader
		*/
		Pass
		{
